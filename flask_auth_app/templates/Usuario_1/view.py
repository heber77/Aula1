...
Usuario_1 = Blueprint('Usuario_1', __name__,  template_folder='pages')

@Usuario_1.route("/templates/Usuario_2/pages/base_2")
def login():
    return render_template ('base_2.html', {{name}})

@Usuario_1.route("/templates/Usuario_1/pages/signup")
def signup():
    return render_template('signup_1.html', signup)

@Usuario_1.route("/templates/Usuario_1/pages/cases_sucesso")
def cases_sucesso():
    return render_template('cases_sucesso.html',cases_sucesso)

@Usuario_1.route("/templates/Usuario_1/pages/cases_sucesso_2")
def cases_sucesso_2():
    return render_template('cases_sucesso_2.html',cases_sucesso_2)

@Usuario_1.route("/templates/Usuario_1/pages/cases_sucesso_3")
def cases_sucesso_3():
    return render_template('cases_sucesso_3.html',cases_sucesso_3)

@Usuario_1.route("/templates/Usuario_1/pages/cases_sucesso_4")
def cases_sucesso_4():
    return render_template('cases_sucesso_4.html',cases_sucesso_4)

@Usuario_1.route("/templates/Usuario_1/pages/cases_sucesso_5")
def cases_sucesso_5():
    return render_template('cases_sucesso_5.html',cases_sucesso_5)

@Usuario_1.route('/anexar_case')
def anexar_case():
    return render_template('anexar_case.html',anexar_case)

@Usuario_1.route('/suporte')
def suporte():
    return render_template('suporte.html',suporte)

@Usuario_1.route('/duvidas_txt')
def duvidas_txt():
    return render_template('duvidas_txt.html',duvidas_txt)

@Usuario_1.route('/profile')
def profile():
    return render_template('profile.html',duvidas_txt)

@Usuario_1.route('/curso')
def curso():
...
...
@Usuario_1.route("/templates/signup_1", methods=['POST'])
def signup_post():
    ...
    if user: # if a user is found, we want to redirect back to signup page so user can try again
        return redirect(url_for('Usuario_1.index'))
...
create_app
@Usuario_1.user_loader
def load_user(user_id):
    return User.get(user_id)

@Usuario_1.route('templates/base', methods=['GET', 'POST'])
def login():
    ...
    if form.validate_on_submit():
        ...
        return flask.redirect(next or flask.url_for("/templates/Usuario_1/pages/base_2"))
    return flask.render_template('base_2.html', form=form)

LoginManager.unauthorized_handler()
g = flask.ext.login.current_user
@Usuario_1.before_request
def load_users():

...
from mimetypes import MimeTypes, init
...
class Utils (object): 
   ...
   @staticmethod 
   def  hmac (chave, string, hex = False) : 
       """
       Calcule o hmac.
       Parâmetros:
           chave: string
       ...
       try:
           ...
           hmac256 = hmac.new (chave, msg = string, digestmod = hashlib.sha256) # v2
   ...
   def  isFileValid (filename, mimetype, allowedExts, allowedMimeTypes) : 
       ...
       return extension.lower () in allowedExts is mimetype in allowedMimeTypes
